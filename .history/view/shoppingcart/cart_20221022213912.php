                    ...
                    <tr>
                        ...
                        <td>
                            <a href="index.php?act=home">
                                <input type="button" class=" bg-sky-300 hover:bg-emerald-800 hover:text-white" value="Tiếp tục mua hàng">
                            </a>
                        </td>
                        <td>
                            <a href="index.php?act=bill">
                                <input type="button" class=" bg-sky-300 hover:bg-emerald-800 hover:text-white" value="Tiến hành đăt hàng">
                            </a>
                        </td>
                        <!-- <td>
                            <a href="index.php?act=bill">
