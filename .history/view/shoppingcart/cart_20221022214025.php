                    ...
                    <tr>
                        ...
                        <td>
                            <a href="index.php?act=home">
                                <input type="button" class="btn bg-sky-300 border hover:bg-emerald-800 hover:text-white" value="Tiếp tục mua hàng">
                            </a>
                        </td>
                        <td>
                            <a href="index.php?act=bill">
                                <input type="button" class="btn bg-sky-300 border border-[] hover:bg-emerald-800 hover:text-white" value="Tiến hành đăt hàng">
                            </a>
                        </td>
                        <!-- <td>
                            <a href="index.php?act=bill">
